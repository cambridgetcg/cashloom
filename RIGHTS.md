...
- Immutable upstream: XENIA release
  [`npm-xenia-v0.1.0-beta.4`](https://github.com/cambridgetcg/xenia/releases/tag/npm-xenia-v0.1.0-beta.4)
  (commit `6419d37dda9fb282242754685dba3edcb4bbf74b`).

Adopting the words is not proof of practising them — the practice is in the
doors: see `/v1/guide` on any running node for what the stranger receives and
what this software promises not to do. A hosted instance's XENIA Covenant
record is a separate, dated, speaker-bound act; it is never self-activated.
